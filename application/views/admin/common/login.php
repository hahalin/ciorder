...
<div class="container">
	<div class="row">
		<div style="margin-top:50px;" class="col-md-5 col-md-offset-4  wall">
			<div class="panel panel-default">
				<div class="panel-heading">
                    <h3 class="panel-title_ ">
                    	<span class="glyphicon glyphicon-user"></span>
                    	<?php echo $this->lang->line('sign_in_to_codeigniter_admin_pro'); ?>
                    </h3>
                    <!-- <legend><?php echo $this->lang->line('sign_in_to_codeigniter_admin_pro'); ?></legend> -->
                </div>
                <div class="panel-body">
                	<form  method="post" class="form-horizontal">
   						<input type="hidden" name="frank_csrf_test_name" value="<?php echo $this->security->get_csrf_hash(); ?>" />
						...
						<div class="form-group">
			              <label class="control-label col-sm-2"><?php echo $this->lang->line('user_name'); ?></label>
			              <div class="col-sm-10">
			                <input class="form-control" type="text" placeholder="<?php echo $this->lang->line('user_name'); ?>" name="crudUser[name]" class="span4"  value="<?php
			            ...
			            <div class="form-group">
			              <label class="control-label col-sm-2"><?php echo $this->lang->line('password'); ?></label>
			              <div class="col-sm-10">
			                <input class="form-control" type="password" placeholder="<?php echo $this->lang->line('password'); ?>"  name="crudUser[password]" class="span4"  value="<?php
			                           if (isset($crudUser['name'])) {
			            ...
			            <div class="form-group">
							<label for="SettingDefaultLanguage" class="control-label col-sm-2"><?php echo $this->lang->line('language'); ?> </label>
							<div class="col-sm-10">
						...
						<div class="form-group" style="margin-top:10px" >
								<div class="col-sm-12 controls">
									<button class="btn btn-lg btn-info btn-block" name="submit" type="submit"><?php echo $this->lang->line('sign_in');?></button>
								</div>
							</div>
